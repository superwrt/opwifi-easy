 ...
 * Changed refernce: http://www.tuicool.com/articles/QZnmUbv
 */
...
(function ($) {
    ...
    BootstrapTable.prototype.initFixedColumns = function () {
        this.$container.find('.fixed-table-column').each(function(i) {
            $(this).remove()
        });
    ...
    BootstrapTable.prototype.initHeader = function () {
        ...
        $tr.html($ths.eq(this.options.fixedColumn).clone());
    ...
    BootstrapTable.prototype.initBody = function () {
        ...
        this.$body.find('> tr[data-index]').each(function () {
            ...
            $tr.html($tds.eq(that.options.fixedColumn).clone());
    ...
    BootstrapTable.prototype.fitHeaderColumns = function () {
        ...
        this.$body.find('tr:first-child:not(.no-records-found) > *').each(function (i) {
            ...
            if (i != that.options.fixedColumn) {
                return i > that.options.fixedColumn ? false : true;
            }
        ...
        this.$tableBody.css("margin-left", headerWidth);
    };
